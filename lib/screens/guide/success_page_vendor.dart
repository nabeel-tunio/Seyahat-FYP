...
import 'package:seyahat/screens/guide/vendor_dashboard.dart';

class SuccessPageVendor extends StatelessWidget {
  final String username;

  const SuccessPageVendor({super.key, required this.username});
              ...
              ElevatedButton(
                onPressed: () {
                  ...
                  Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                      builder: (context) => VendorDashboard(username: username),
                    ),
                  );
                },
